...
fs         = 10000
N          = 35 #este se calcula como el largo de la FFT elegida MENOS M+1

filterFile='filtro.npy'
...
firData = np.array(np.load(filterFile).astype(float))
firData = np.ravel(firData.T)
M       = len(firData)

print("firData",firData)
